...
<div align="center">
  ...
  [![YouTube](https://img.shields.io/badge/YouTube-%23FF0000.svg?style=for-the-badge&logo=YouTube&logoColor=white)](https://www.youtube.com/watch?v=NXt0J5pUHhM)
</div>
...
## Outro
  <details>
    ...
    <ul>
      ...
      <li>많은 것을 개선했지만 본 프로젝트에서는 JWT토큰을 localStorage에 저장하는 방식을 사용하여 보안상의 문제가 될 수 있다는 점을 꺠달았습니다. 서버에서 HTTP Only 쿠키를 통해 토큰을 관리하는 방식이 더 안전하다는걸 배웠습니다.</li>
    </ul>
  </details>
<br>
